import svgPaths from "./svg-1kg6s6uggg";
...
function NavContent() {
  return (
    <div className="absolute h-[92px] left-0 top-0 w-[1440px]" data-name="Nav content">
      <LeftContent />
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*1)+(var(--transform-inner-height)*0)))] items-center justify-center left-[1236px] top-[87px] w-[calc(1px*((var(--transform-inner-height)*1)+(var(--transform-inner-width)*0)))]" style={{ "--transform-inner-width": "5", "--transform-inner-height": "115" } as React.CSSProperties}>
...
function Divider2() {
  return <div className="absolute bg-[#e6e8ec] h-px left-0 top-[92px] w-[1440px]" data-name="divider" />;
}
